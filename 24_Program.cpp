...
Data abstraction refers to providing only essential information to the outside
 world and hiding their background details, i.e., to represent the needed information 
...
data, i.e., state without actually knowing how class has been implemented internally.
...
level remains in effect until the next access label is encountered or the closing right brace of the class body is seen.
...
what affect the change may have. If data is public, 
